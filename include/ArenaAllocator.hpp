...
//
// The returned pointer is non-owning in the usual sense: the arena, not
// the caller, controls the object's lifetime. It stays valid until the
// arena is reset(), rolled back past it, or destroyed, the caller never
// deletes it directly.
